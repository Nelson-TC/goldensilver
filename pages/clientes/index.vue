<template>
  <div class="max-w-6xl mx-auto bg-white/80 rounded-2xl shadow-lg p-8 mt-6">
    ...
    <NuxtLink to="/clientes/nuevo" class="mb-4 inline-block px-4 py-2 bg-blue-500 text-white rounded-lg font-semibold shadow hover:bg-blue-600 transition">Agregar Cliente</NuxtLink>
